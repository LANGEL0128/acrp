...
export const FrontShowMemberScreen = () => {
  const tags_name = 'miembros';
    ...
    return (
        <div className="card animate__animated animate__fadeIn shadow m-2">
                ...
                { 
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 d-flex justify-content-end">
                            <Link to={"/"+tags_name} className='btn btn-secondary' >Atrás</Link>
                        </div>
                    </div>
                }
            </div>
